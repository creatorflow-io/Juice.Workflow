...
namespace Juice.Workflows.Api.Behaviors
{
    ...
    {
        public WorkflowStateTransactionBehavior(WorkflowPersistDbContext dbContext,
            IIntegrationEventService<WorkflowPersistDbContext, IWorkflowEventBus> integrationEventService,
